...
class ResNet_locate(nn.Module):
    ...
    def load_pretrained_model(self):
        self.resnet.load_state_dict('/home/caoyiwen/pretrained weights/resnet50-timm.pth', strict=False)
...
def resnet50_locate():
    ...
    model.load_state_dict(torch.load('/home/caoyiwen/pretrained weights/resnet50-timm.pth'), strict=False)
    return model
