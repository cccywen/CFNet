...
from geoseg.models.UCTransNet import uctrans_net
...
classes = CLASSES
weights_name = "trans-pre-e100"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "trans-pre-e100-v5"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/MyBES/model_weights/vaihingen/bes-orimabes-e150/bes-orimabes-e150-v1.ckpt'
pretrained_ckpt_path = None
resume_ckpt_path = None
#  define the network
net = uctrans_net(n_classes=num_classes)
