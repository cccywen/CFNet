...
class Setr_ConvFormer(nn.Module):
    def __init__(self, n_classes, imgsize=256, patch_num=32, dim=512, depth=4, heads=8, mlp_dim=512*2, dim_head=64, dropout=0.1, emb_dropout=0.1):
        super().__init__()
