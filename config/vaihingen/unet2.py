...
from geoseg.models.OriUnet import MyUNet
...
classes = CLASSES
weights_name = "unet42-e100"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "unet42-e100-v4"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/asfunet2-test-e100/asfunet2-test-e100-v4.ckpt'
pretrained_ckpt_path = None
resume_ckpt_path = None
#  define the network
# net = BESNet(nclass=num_classes, aux=False, pretrained=True)
net = MyUNet(n_classes=num_classes)
