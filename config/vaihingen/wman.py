...
from geoseg.models.MANPoolUnet import PoolUNet
...
classes = CLASSES
weights_name = "manpoolu-e100-822"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "manpoolu-e100-807"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/CFNet/model_weights/vaihingen/wmanpoolu-e70-819/wmanpoolu-e70-819.ckpt'
