...
classes = CLASSES
weights_name = "oriunet41-1-e150"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "oriunet41-1-e150"
...
gpus = [0]
strategy = None
pretrained_ckpt_path = '/home/caoyiwen/slns/MyBES/model_weights/vaihingen/oriunet41-1-e100/oriunet41-1-e100.ckpt'
