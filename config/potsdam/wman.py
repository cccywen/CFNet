...
from geoseg.models.WeiMANPoolUnet import PoolUNet
...
classes = CLASSES
weights_name = "wmanpoolu-e70"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "wmanpoolu-e70-v2"
...
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/potsdam/manfpn-ori-e80/manfpn-ori-e80-v2.ckpt'
