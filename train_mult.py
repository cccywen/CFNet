...
def main():
    ...
    a = "/home/caoyiwen/slns/CFNet/config/vaihingen/convformer.py"
    # a = "/home/caoyiwen/slns/CFNet/config/vaihingen/cfnet1.py"
    # a = "/home/caoyiwen/slns/CFNet/config/vaihingen/tm2.py"
    # a = "/home/caoyiwen/slns/CFNet/config/vaihingen/uformer.py"
    config = py2cfg(a)
    ...
    trainer = pl.Trainer(gpus=[0,1,2,3], max_epochs=config.max_epoch, accelerator='gpu',
                         check_val_every_n_epoch=config.check_val_every_n_epoch,
                         callbacks=[checkpoint_callback], strategy="dp",
