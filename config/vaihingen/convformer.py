...
from geoseg.datasets.vaihingen_new import *
# from geoseg.models.MALST import MANet
from geoseg.models.ConvFormer2 import Setr_ConvFormer
...
classes = CLASSES
weights_name = "convformer-new-e90"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "convformer-new-e90-v2"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/tm2-new-e120-829/tm2-new-e120-8298.ckpt'
pretrained_ckpt_path = None
resume_ckpt_path = None
#  define the network
net = Setr_ConvFormer(n_classes=num_classes)
