...
from geoseg.models.PSPUnet222 import PoolUNet
...
classes = CLASSES
weights_name = "db-pspunet-e75"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "db-pspunet-e75-8232"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/db-pspunet-e100/db-pspunet-e100-821.ckpt'
